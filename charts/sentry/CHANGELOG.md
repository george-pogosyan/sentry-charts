...
## [30.0.0](https://github.com/george-pogosyan/sentry-charts/compare/sentry-v29.4.1...sentry-v30.0.0) (2026-03-13)


### ⚠ BREAKING CHANGES

* replace nginx chart, refactor ingress, unify routing configurations ([#2012](https://github.com/george-pogosyan/sentry-charts/issues/2012))
* remove bundled clickhouse chart ([#2029](https://github.com/george-pogosyan/sentry-charts/issues/2029))
* replace bitnami/memcached with cloudpirates/memcached ([#2014](https://github.com/george-pogosyan/sentry-charts/issues/2014))
* upgrade to v25.12.1 ([#1981](https://github.com/george-pogosyan/sentry-charts/issues/1981))
* **deps:** update helm release clickhouse to v4 ([#1775](https://github.com/george-pogosyan/sentry-charts/issues/1775))
...
* add `imagePullSecrets` option to the metrics deployment ([#1722](https://github.com/george-pogosyan/sentry-charts/issues/1722)) ([3463781](https://github.com/george-pogosyan/sentry-charts/commit/3463781b9f1dcba2350e8d6bef9aa4dfc9e12083))
* add cache, logging, and kafka configuration options to sentry relay ([#1438](https://github.com/george-pogosyan/sentry-charts/issues/1438)) ([4a84c9f](https://github.com/george-pogosyan/sentry-charts/commit/4a84c9f5168969e044c0303ca81b60ce743303fd))
* add clickhouse ssl config ([#1671](https://github.com/george-pogosyan/sentry-charts/issues/1671)) ([a48f91c](https://github.com/george-pogosyan/sentry-charts/commit/a48f91c8218cb9f9363c249a02407e776f5ced1c))
* add configurable clusterDomain to global section in values.yaml ([#2048](https://github.com/george-pogosyan/sentry-charts/issues/2048)) ([9d9b36d](https://github.com/george-pogosyan/sentry-charts/commit/9d9b36de11636e38d2a461c66004630b3041726f))
* add configuration for noStrictOffsetReset ([#1620](https://github.com/george-pogosyan/sentry-charts/issues/1620)) ([234552e](https://github.com/george-pogosyan/sentry-charts/commit/234552e186a5b9ed814595ce83bc744034c93821))
* add custom labels for ingress ([#1672](https://github.com/george-pogosyan/sentry-charts/issues/1672)) ([712a469](https://github.com/george-pogosyan/sentry-charts/commit/712a4696a2d163ee83baad61453e7a3fa2da4f3d))
* add distributed cluster name config ([#1780](https://github.com/george-pogosyan/sentry-charts/issues/1780)) ([1ce32ab](https://github.com/george-pogosyan/sentry-charts/commit/1ce32ab717ce022730021e629dbeb1d2dd30a5b3))
* add errors-only mode from original self-hosted compose ([#1810](https://github.com/george-pogosyan/sentry-charts/issues/1810)) ([3f29825](https://github.com/george-pogosyan/sentry-charts/commit/3f29825126050887312bc6a5828a4d34aa2aa444))
* add excludequeues option to sentry worker deployment ([#1441](https://github.com/george-pogosyan/sentry-charts/issues/1441)) ([78e80fb](https://github.com/george-pogosyan/sentry-charts/commit/78e80fb35677b1174e9d6d5dcbc37f58a32b86ac))
* add existingSecretEnv support for web and worker deployments ([#1509](https://github.com/george-pogosyan/sentry-charts/issues/1509)) ([b170ac3](https://github.com/george-pogosyan/sentry-charts/commit/b170ac33a64e41a36bfeb416e05801ec9ae1365d))
* add geoip support to sentry deployment ([#1516](https://github.com/george-pogosyan/sentry-charts/issues/1516)) ([4f2429b](https://github.com/george-pogosyan/sentry-charts/commit/4f2429b746fe13002c21abf233338a293acff1a0))
* add global nodeSelector fallback for all deployments ([#1576](https://github.com/george-pogosyan/sentry-charts/issues/1576)) ([d6eec42](https://github.com/george-pogosyan/sentry-charts/commit/d6eec42b2c31f42a473d1241721ff3d64111400f))
* add Kafka topics from upstream projects (Sentry and Snuba) for version 24.12.2 ([#1678](https://github.com/george-pogosyan/sentry-charts/issues/1678)) ([cf696b7](https://github.com/george-pogosyan/sentry-charts/commit/cf696b75d1c13b9f1af3388c3d818b8fdffee71b))
* add logging and worker settings to Sentry web deployment ([#1459](https://github.com/george-pogosyan/sentry-charts/issues/1459)) ([f0427e2](https://github.com/george-pogosyan/sentry-charts/commit/f0427e219773382eee4580bc4170d221f5150eee))
* add logLevel and logFormat options for worker events and transactions ([#1542](https://github.com/george-pogosyan/sentry-charts/issues/1542)) ([bfbdd4d](https://github.com/george-pogosyan/sentry-charts/commit/bfbdd4d95bf15b18a72ed3d5af2baa363e98d6b6))
* add logLevel option to ingestConsumerAttachments ([#1468](https://github.com/george-pogosyan/sentry-charts/issues/1468)) ([8005f0f](https://github.com/george-pogosyan/sentry-charts/commit/8005f0fcebf9856a3a29a99f596452a2c481a58c))
* add logLevel, maxPollIntervalMs, inputBlockSize, maxBatchTimeMs ([#1403](https://github.com/george-pogosyan/sentry-charts/issues/1403)) ([78de49b](https://github.com/george-pogosyan/sentry-charts/commit/78de49b0f94633cf098aff320a79d7a48443b9a5))
* add maxBatchTimeMs, maxPollIntervalMs for ingestConsumerAttachments ([#1591](https://github.com/george-pogosyan/sentry-charts/issues/1591)) ([72af218](https://github.com/george-pogosyan/sentry-charts/commit/72af2189d2249cc29de1442179ce2258da958e44))
* add maxPollIntervalMs to consumers ([#1805](https://github.com/george-pogosyan/sentry-charts/issues/1805)) ([267acc7](https://github.com/george-pogosyan/sentry-charts/commit/267acc7e6bd0313cada0fcce40dfa54f063ca24d))
* add maxTasksPerChild option to Sentry worker deployments ([#1572](https://github.com/george-pogosyan/sentry-charts/issues/1572)) ([bc32900](https://github.com/george-pogosyan/sentry-charts/commit/bc329004f46f4af7ecf4a99f07e74e28dbee436e))
* add missing Kubernetes pod configuration options ([#1926](https://github.com/george-pogosyan/sentry-charts/issues/1926)) ([7083a0e](https://github.com/george-pogosyan/sentry-charts/commit/7083a0ececa5bbb2a0ac868620ce2e46061d599d))
* Add missing sidecar and global parameter for deployments & hooks ([#1230](https://github.com/george-pogosyan/sentry-charts/issues/1230)) ([ac8143f](https://github.com/george-pogosyan/sentry-charts/commit/ac8143fd1607c0493ea5c60940be3e649f6d613b))
* Add monitorsClockTasks and monitorsClockTick ([#1690](https://github.com/george-pogosyan/sentry-charts/issues/1690)) ([1fe663d](https://github.com/george-pogosyan/sentry-charts/commit/1fe663d345c9e420c901f25dc306e0e27549d905))
* add more values for sentry ([#1765](https://github.com/george-pogosyan/sentry-charts/issues/1765)) ([cdd0905](https://github.com/george-pogosyan/sentry-charts/commit/cdd0905581c01309caee734e9f778add0cf3cf4c))
* add noStrictOffsetReset for ingest-consumer-attachments ([#1398](https://github.com/george-pogosyan/sentry-charts/issues/1398)) ([599294c](https://github.com/george-pogosyan/sentry-charts/commit/599294c33b9e5dfd076e581386a614f60fca38ef))
* add optional environment variables for nodestore init container ([#2019](https://github.com/george-pogosyan/sentry-charts/issues/2019)) ([b4dab3d](https://github.com/george-pogosyan/sentry-charts/commit/b4dab3dde3bffb999961947274e3cd3291e2e170))
* Add optional memory-based autoscaling to all HPA components ([#2071](https://github.com/george-pogosyan/sentry-charts/issues/2071)) ([3e10c57](https://github.com/george-pogosyan/sentry-charts/commit/3e10c570d076d17ff81b2ada47245c390b661635))
...
* add params for consumers ([#1824](https://github.com/george-pogosyan/sentry-charts/issues/1824)) ([883d9ea](https://github.com/george-pogosyan/sentry-charts/commit/883d9ea6d7918128367d9c1e1554e8dbe1bfc03b))
* add recommended labels ([#1839](https://github.com/george-pogosyan/sentry-charts/issues/1839)) ([4ae9f92](https://github.com/george-pogosyan/sentry-charts/commit/4ae9f92e7d2da33d0860760efabd13dd00e4734e))
* add variable for SAMPLED_DEFAULT_RATE ([#1634](https://github.com/george-pogosyan/sentry-charts/issues/1634)) ([7910f9d](https://github.com/george-pogosyan/sentry-charts/commit/7910f9d0030b9c09206e01762e284003d9e61639))
* align defaults to sentry self hosted repo ([#2031](https://github.com/george-pogosyan/sentry-charts/issues/2031)) ([86b4c7c](https://github.com/george-pogosyan/sentry-charts/commit/86b4c7c2f05d410df81ea67cf50578d335db2a25))
* allow customization of kafka configuration ([#1514](https://github.com/george-pogosyan/sentry-charts/issues/1514)) ([5f4009b](https://github.com/george-pogosyan/sentry-charts/commit/5f4009b97898bea66749436b792e4a9815df4be8))
* allow users to specify Kafka topic name prefix in values.yaml ([#1544](https://github.com/george-pogosyan/sentry-charts/issues/1544)) ([5693406](https://github.com/george-pogosyan/sentry-charts/commit/569340626ce1587d48040a939b80ab74874fd022))
* breaking change note ([9e5a15e](https://github.com/george-pogosyan/sentry-charts/commit/9e5a15e045fffcaccd88d5dc40c835c0083ffd47))
* bump appversion from 25.8.0 to 25.9.0 ([#1927](https://github.com/george-pogosyan/sentry-charts/issues/1927)) ([5a5d1a9](https://github.com/george-pogosyan/sentry-charts/commit/5a5d1a90a048743619e968e18ba1b5b80b601ade))
* change pgbouncer repository ([#1908](https://github.com/george-pogosyan/sentry-charts/issues/1908)) ([8101fb9](https://github.com/george-pogosyan/sentry-charts/commit/8101fb9d2260e0e98f5ceb4dced88c22c714347f))
* **clickhouse:** db cleanup ([#1876](https://github.com/george-pogosyan/sentry-charts/issues/1876)) ([e2e911d](https://github.com/george-pogosyan/sentry-charts/commit/e2e911d6ac5c48fe4cd138469b07f215093d341b))
* **clickhouse:** remove explicit imageVersion, inherit from chart ([#1561](https://github.com/george-pogosyan/sentry-charts/issues/1561)) ([4d003fd](https://github.com/george-pogosyan/sentry-charts/commit/4d003fdc350f1427d413285b94bf27fd13635239))
* **clickhouse:** update ClickHouse chart to 3.12.0 ([#1556](https://github.com/george-pogosyan/sentry-charts/issues/1556)) ([07e73c1](https://github.com/george-pogosyan/sentry-charts/commit/07e73c1846c242f1babaa1ed47271588c9ec2daf))
* **cronjob:** add filesystem cleanup cronjob for filesystem backend ([#2037](https://github.com/george-pogosyan/sentry-charts/issues/2037)) ([a7a1b78](https://github.com/george-pogosyan/sentry-charts/commit/a7a1b78b74a363b7a3a3273c3e3868f78377a0ed))
* **deps:** update helm release clickhouse to v4 ([#1775](https://github.com/george-pogosyan/sentry-charts/issues/1775)) ([4e86110](https://github.com/george-pogosyan/sentry-charts/commit/4e8611025be55045f948f951aa1b8869971f0419))
* disable Sentry anonymous usage statistics ([#1608](https://github.com/george-pogosyan/sentry-charts/issues/1608)) ([b679d97](https://github.com/george-pogosyan/sentry-charts/commit/b679d97e21e787857a7d1dc8fd7c84ceb759e083))
* Enhance clickhouse cleanup job ([#1886](https://github.com/george-pogosyan/sentry-charts/issues/1886)) ([af06a25](https://github.com/george-pogosyan/sentry-charts/commit/af06a259dc0a4f0fe36ccf40cf73c7e27570a876))
* enhance logging options and add missing configuration parameters ([#1419](https://github.com/george-pogosyan/sentry-charts/issues/1419)) ([c666226](https://github.com/george-pogosyan/sentry-charts/commit/c666226346114998ff3c04a005d494e79bd7e13e))
* enhance nginx config to handle disabled sentry relay ([#1430](https://github.com/george-pogosyan/sentry-charts/issues/1430)) ([4395dba](https://github.com/george-pogosyan/sentry-charts/commit/4395dba949ca41375bcf0c24435344406cc2bbb7))
* **gateway:** add gateway api httpRoute support ([#2016](https://github.com/george-pogosyan/sentry-charts/issues/2016)) ([1c9a2f9](https://github.com/george-pogosyan/sentry-charts/commit/1c9a2f9c8501a0a140b49d62525705e193afcece))
* **hook:** ArgoCd Compatible Annotations for hook ([#1977](https://github.com/george-pogosyan/sentry-charts/issues/1977)) ([45f9ae9](https://github.com/george-pogosyan/sentry-charts/commit/45f9ae9f4c98fb8f86866715ec9e07916e08fa2e))
* **hpa:** add behavior support for hpa v2 ([#1855](https://github.com/george-pogosyan/sentry-charts/issues/1855)) ([f5b8f7b](https://github.com/george-pogosyan/sentry-charts/commit/f5b8f7b8bfb5e34bec02e3b3be132340a270bdbb))
* **ingress:** Add native Traefik IngressRoute support ([#1972](https://github.com/george-pogosyan/sentry-charts/issues/1972)) ([096bac6](https://github.com/george-pogosyan/sentry-charts/commit/096bac6c0992b70b92e2fdc0593c1128aaf5b818))
* Introduce global tolerations across all components ([#1580](https://github.com/george-pogosyan/sentry-charts/issues/1580)) ([7b48399](https://github.com/george-pogosyan/sentry-charts/commit/7b48399efe73cbb582b4df34068d0104ae3d969c))
* offset-reset in ds ([#1533](https://github.com/george-pogosyan/sentry-charts/issues/1533)) ([0e3ef2d](https://github.com/george-pogosyan/sentry-charts/commit/0e3ef2db47c552fc80d07442263764a33c11c0d3))
* optional separate replay storage ([#2040](https://github.com/george-pogosyan/sentry-charts/issues/2040)) ([404c688](https://github.com/george-pogosyan/sentry-charts/commit/404c6884e9f16f290053350e153d114d4b59d6d5))
* persistence improvements ([#1853](https://github.com/george-pogosyan/sentry-charts/issues/1853)) ([93e598a](https://github.com/george-pogosyan/sentry-charts/commit/93e598a8e1da5f4202804b260fb042dac4d96b7d))
* pgbouncer for postgresql ([#1607](https://github.com/george-pogosyan/sentry-charts/issues/1607)) ([07157bd](https://github.com/george-pogosyan/sentry-charts/commit/07157bd61bff026cd80d912d16c140c9168d90d3))
* **pgbouncer/deployment:** Pass (extra) env from values ([#1946](https://github.com/george-pogosyan/sentry-charts/issues/1946)) ([d07a58b](https://github.com/george-pogosyan/sentry-charts/commit/d07a58b0a428c5e3a20764ff114d146fc060fd4e))
* **rabbitmq:** updated configuration to support Prometheus ([#1578](https://github.com/george-pogosyan/sentry-charts/issues/1578)) ([35f779a](https://github.com/george-pogosyan/sentry-charts/commit/35f779a0f18b2b9108470efc86403fa3c0eefae2))
* recovery support multi hosts and ports of external kafka cluster ([#1588](https://github.com/george-pogosyan/sentry-charts/issues/1588)) ([889bd0d](https://github.com/george-pogosyan/sentry-charts/commit/889bd0d47235cb1ab5a7b52439f5b8df61026a03))
* reintroduce "Extend Redis functionality" ([#1492](https://github.com/george-pogosyan/sentry-charts/issues/1492)) ([0b7a7b4](https://github.com/george-pogosyan/sentry-charts/commit/0b7a7b4c874bf4d4a460c88bb259cab0e025f7ee))
* replace bitnami/memcached with cloudpirates/memcached ([#2014](https://github.com/george-pogosyan/sentry-charts/issues/2014)) ([1092a3c](https://github.com/george-pogosyan/sentry-charts/commit/1092a3c982477d0eb2d5c827d393c95b30d28be7))
* replace nginx chart, refactor ingress, unify routing configurations ([#2012](https://github.com/george-pogosyan/sentry-charts/issues/2012)) ([c7748d5](https://github.com/george-pogosyan/sentry-charts/commit/c7748d5562f84a43525a7b1d17d538a806c95c5a))
* Sentry 24.11.2 ([#1640](https://github.com/george-pogosyan/sentry-charts/issues/1640)) ([70d0710](https://github.com/george-pogosyan/sentry-charts/commit/70d0710d0f063d346eb0743ef2745ce40d57c764))
* **sentry:** Add missing --no-strict-offset-reset and --auto-offset-reset for consumers ([#1535](https://github.com/george-pogosyan/sentry-charts/issues/1535)) ([8e0eea0](https://github.com/george-pogosyan/sentry-charts/commit/8e0eea0e5a3805c93d19ea93240d634953461cea))
* **sentry:** add sasl auth for kafka and manage settings of connections ([#1557](https://github.com/george-pogosyan/sentry-charts/issues/1557)) ([f5a12e0](https://github.com/george-pogosyan/sentry-charts/commit/f5a12e04ee5ffa28f1d62bf6c7cb5c733b30c2b9))
* **sentry:** bump nginx to 22.3.9 ([#1978](https://github.com/george-pogosyan/sentry-charts/issues/1978)) ([c83e9dc](https://github.com/george-pogosyan/sentry-charts/commit/c83e9dccb985d71aa5a1e8c25437627dd1fe5350))
* **sentry:** upgrade version ([#1819](https://github.com/george-pogosyan/sentry-charts/issues/1819)) ([afe197c](https://github.com/george-pogosyan/sentry-charts/commit/afe197cc17021f5a8a38f75c0760058f3f828423))
* sessionAffinityConfig and sessionAffinity for pgbouncer service ([#1964](https://github.com/george-pogosyan/sentry-charts/issues/1964)) ([0af7560](https://github.com/george-pogosyan/sentry-charts/commit/0af7560d30e77c312674af2dae8b3605aa21e00a))
* **snuba:** add deployment configuration for EAP items consumer ([#1818](https://github.com/george-pogosyan/sentry-charts/issues/1818)) ([a4e1749](https://github.com/george-pogosyan/sentry-charts/commit/a4e1749e6c3dd8deca9ffa113331b3a8eafc50b9))
* **snuba:** add deployment configuration for generic metrics gauges consumer ([#1800](https://github.com/george-pogosyan/sentry-charts/issues/1800)) ([3ae3580](https://github.com/george-pogosyan/sentry-charts/commit/3ae35804207f124e1d50d8271bd7f2eeabc137e7))
* **snuba:** add deployment profile chunks ([#1799](https://github.com/george-pogosyan/sentry-charts/issues/1799)) ([5addbf3](https://github.com/george-pogosyan/sentry-charts/commit/5addbf3ab7e134ba187c6fc9a9973fc3f01e3ea0))
* **snuba:** add events_analytics_platform to settings ([#1540](https://github.com/george-pogosyan/sentry-charts/issues/1540)) ([b035b10](https://github.com/george-pogosyan/sentry-charts/commit/b035b10fb96d7081abcab8cf03a5f63e814a4871))
* support gcs as profiles backend ([#2051](https://github.com/george-pogosyan/sentry-charts/issues/2051)) ([6edda3b](https://github.com/george-pogosyan/sentry-charts/commit/6edda3bf5cf27e52ae641253f4bd9c0301c3a9bf))
* **symbolicator:** implement deployment and statefulset selection ([#1453](https://github.com/george-pogosyan/sentry-charts/issues/1453)) ([112c1b5](https://github.com/george-pogosyan/sentry-charts/commit/112c1b50456273163f6692d16787c4d04fe87cda))
* **Symbolicator:** Map storageClassName in symbolicator PVC ([#1958](https://github.com/george-pogosyan/sentry-charts/issues/1958)) ([144358a](https://github.com/george-pogosyan/sentry-charts/commit/144358ae41c133325a1f81b63c2bd695d707e1c9))
* sync feature flags with self-hosted configuration 25.9.0 ([#1985](https://github.com/george-pogosyan/sentry-charts/issues/1985)) ([4bf8840](https://github.com/george-pogosyan/sentry-charts/commit/4bf8840ce558ef9ab103c6fa6f2e0847c903a5fd))
* update appVersion to 25.1.0 and add topic ([#1686](https://github.com/george-pogosyan/sentry-charts/issues/1686)) ([31e7368](https://github.com/george-pogosyan/sentry-charts/commit/31e73689f25ef1ab4d17e6f41a16d91b62a4d475))
* update appVersion to 25.2.0 ([#1713](https://github.com/george-pogosyan/sentry-charts/issues/1713)) ([8c5fc21](https://github.com/george-pogosyan/sentry-charts/commit/8c5fc210556bd6b7f604709ccfc9aa30ea1cd0b8))
* update appVersion to 25.3.0 ([#1740](https://github.com/george-pogosyan/sentry-charts/issues/1740)) ([9ed13bb](https://github.com/george-pogosyan/sentry-charts/commit/9ed13bbd7b604681ee8079bb53d427376552a40a))
* update kafka for fix jmx-exporter scrape path ([#1477](https://github.com/george-pogosyan/sentry-charts/issues/1477)) ([a1c6250](https://github.com/george-pogosyan/sentry-charts/commit/a1c6250f70245f6514ddbe8e15741250bd6de1a2))
* update sentry appVersion to 24.8.0 ([#1569](https://github.com/george-pogosyan/sentry-charts/issues/1569)) ([cb731e0](https://github.com/george-pogosyan/sentry-charts/commit/cb731e0cba028907fff29ed9e1525e544694ec32))
* update sentry appVersion to 24.9.0 ([#1571](https://github.com/george-pogosyan/sentry-charts/issues/1571)) ([2a3a030](https://github.com/george-pogosyan/sentry-charts/commit/2a3a030ba3c61c6792712c4f637fe64d42a47fe2))
* update sentry appVersion to v25.4.0 ([#1754](https://github.com/george-pogosyan/sentry-charts/issues/1754)) ([b34f26d](https://github.com/george-pogosyan/sentry-charts/commit/b34f26d95b29970152b33c45dbb9ee94fe3a5515))
* update sentry appVersion to v25.5.1 ([#1782](https://github.com/george-pogosyan/sentry-charts/issues/1782)) ([9e9a05f](https://github.com/george-pogosyan/sentry-charts/commit/9e9a05f1930bd3e58c4fa94eefc5dd78ca9c72e3))
* update Sentry chart to appVersion 24.10.0 ([#1652](https://github.com/george-pogosyan/sentry-charts/issues/1652)) ([72f61ff](https://github.com/george-pogosyan/sentry-charts/commit/72f61ff7ae1a26d11865cec083861041d94e029d))
* update sentry to v26 ([#2015](https://github.com/george-pogosyan/sentry-charts/issues/2015)) ([22c44f0](https://github.com/george-pogosyan/sentry-charts/commit/22c44f0c84a054be818c7812427f17f8e829aa03))
* updated sentry to 24.7.1 ([#1454](https://github.com/george-pogosyan/sentry-charts/issues/1454)) ([7874e56](https://github.com/george-pogosyan/sentry-charts/commit/7874e569217e8469c5ce40087ecd656309a01bba))
* upgrade to 25.8.0 ([#1851](https://github.com/george-pogosyan/sentry-charts/issues/1851)) ([d3a3ed4](https://github.com/george-pogosyan/sentry-charts/commit/d3a3ed486c264d56f11e7fbf0023757e8914fdf4))
* upgrade to v25.12.1 ([#1981](https://github.com/george-pogosyan/sentry-charts/issues/1981)) ([709b8f7](https://github.com/george-pogosyan/sentry-charts/commit/709b8f715a007feb3e6f180106923eae31b0d86a))
* upgrade to v26.2.0 ([#2053](https://github.com/george-pogosyan/sentry-charts/issues/2053)) ([2180e03](https://github.com/george-pogosyan/sentry-charts/commit/2180e0382f80a8720633adc6ae97693e0c29025f))
* upgrade to v26.2.1 ([22ae555](https://github.com/george-pogosyan/sentry-charts/commit/22ae5555474653532f7030c22bfad23d65775674))


### Bug Fixes

* [#1859](https://github.com/george-pogosyan/sentry-charts/issues/1859) & [#1863](https://github.com/george-pogosyan/sentry-charts/issues/1863) ([#1861](https://github.com/george-pogosyan/sentry-charts/issues/1861)) ([e0879f9](https://github.com/george-pogosyan/sentry-charts/commit/e0879f947eb3145c6a9874bc867ee872d5fbdd42))
* add Kafka topics from upstream projects (Sentry and Snuba) for version 24.9.0 ([#1647](https://github.com/george-pogosyan/sentry-charts/issues/1647)) ([cac64cf](https://github.com/george-pogosyan/sentry-charts/commit/cac64cff98fe9b11a29c83e5f562086ad5f4e00a))
* add migrations excludePatterns for clickHouse cleanup ([#1941](https://github.com/george-pogosyan/sentry-charts/issues/1941)) ([a634c32](https://github.com/george-pogosyan/sentry-charts/commit/a634c328f0d2e4b12f4df8477fe3028499e3da1e))
* add missing dnsPolicy to deployments ([#2046](https://github.com/george-pogosyan/sentry-charts/issues/2046)) ([ea1e67a](https://github.com/george-pogosyan/sentry-charts/commit/ea1e67a5d826ed9efacbb1195e1ab70ff08d1a77))
* Add missing global sidecar to ingestConsumerTransactions deployment ([#1705](https://github.com/george-pogosyan/sentry-charts/issues/1705)) ([5a9f5d7](https://github.com/george-pogosyan/sentry-charts/commit/5a9f5d762dfa693374f598fd8eec9754cc17ad6c))
* Add missing ingest for feedback events ([#1630](https://github.com/george-pogosyan/sentry-charts/issues/1630)) ([3882cae](https://github.com/george-pogosyan/sentry-charts/commit/3882cae9b5cde0591f87b9021e09ddbad27ca659))
* Add missing topics for snuba-subscription-consumer-eap-items ([#1888](https://github.com/george-pogosyan/sentry-charts/issues/1888)) ([8bf1cec](https://github.com/george-pogosyan/sentry-charts/commit/8bf1cec03cf5cf3b06efc3327d35424486849bb4))
* add topic partition counts in snuba config for correct ([#1489](https://github.com/george-pogosyan/sentry-charts/issues/1489)) ([2b44fb2](https://github.com/george-pogosyan/sentry-charts/commit/2b44fb2a449410a64aa4628e06fdd4e1cb1ae6aa))
* add vroom PVC Helm hooks when enable profiling feature ([#1950](https://github.com/george-pogosyan/sentry-charts/issues/1950)) ([a10e3fe](https://github.com/george-pogosyan/sentry-charts/commit/a10e3fedd9060b4e276cc7b3854306d898b08437))
* bitnamilegacy image for kafka jmx exporter ([#1884](https://github.com/george-pogosyan/sentry-charts/issues/1884)) ([6514662](https://github.com/george-pogosyan/sentry-charts/commit/65146629decbc69d7e62f978c2c3e2e0ade8a8b1))
* change default values again ([a282b7e](https://github.com/george-pogosyan/sentry-charts/commit/a282b7e718c37c7d5d25aef19b6372ae00180ab0))
* change followed consumer group from eap_spans_group to eap_items_group ([#1970](https://github.com/george-pogosyan/sentry-charts/issues/1970)) ([809d94a](https://github.com/george-pogosyan/sentry-charts/commit/809d94ad4a18369e2741f3bca38e2112fdc3f434))
* clickhouse env. ([#1786](https://github.com/george-pogosyan/sentry-charts/issues/1786)) ([3f13f00](https://github.com/george-pogosyan/sentry-charts/commit/3f13f00882c339f65500c50a96272db41be5b365))
* clickhouse replicas 1 ([d789562](https://github.com/george-pogosyan/sentry-charts/commit/d789562cbde4371b0057272976a981f66229ca50))
* clickhouse-chart for correct placement of internal_replication ([#1662](https://github.com/george-pogosyan/sentry-charts/issues/1662)) ([a3e82be](https://github.com/george-pogosyan/sentry-charts/commit/a3e82be0f081e4e548658d7acecdcb761a57b469))
* conditionally set auto-offset-reset for snuba subscription consumers ([#1538](https://github.com/george-pogosyan/sentry-charts/issues/1538)) ([db26b85](https://github.com/george-pogosyan/sentry-charts/commit/db26b853246e8f213d25f8c5041893e54a556630))
* configuring kafka to use zookeeper uses only brokers, and service name in db-check is wrong ([#1494](https://github.com/george-pogosyan/sentry-charts/issues/1494)) ([34d4975](https://github.com/george-pogosyan/sentry-charts/commit/34d49752a9869372a69ce6add1011be1155ec254))
* Convert github-app.id to integer for Sentry 26.x compatibility ([#2022](https://github.com/george-pogosyan/sentry-charts/issues/2022)) ([0b9de28](https://github.com/george-pogosyan/sentry-charts/commit/0b9de28e344b6766a0deec9ff5ebc91ed7dc1d5c))
* correct argument order of consumers ([#1522](https://github.com/george-pogosyan/sentry-charts/issues/1522)) ([6236a74](https://github.com/george-pogosyan/sentry-charts/commit/6236a74e70a78525a6030ade5cd3fc29b424fe59))
* correct nginx.conf and ingress settings for sentry 24.7.1 and ([#1466](https://github.com/george-pogosyan/sentry-charts/issues/1466)) ([cfb90ef](https://github.com/george-pogosyan/sentry-charts/commit/cfb90efd05b7b1b03cf191df4324e2092f50e4dc))
* correct order of arguments of sentry consumers ([#1463](https://github.com/george-pogosyan/sentry-charts/issues/1463)) ([#1464](https://github.com/george-pogosyan/sentry-charts/issues/1464)) ([2861efa](https://github.com/george-pogosyan/sentry-charts/commit/2861efa7192b8d8bc02835ef4ade16a21b2729f1))
* correct podLabels type from list to map in values.yaml ([#1448](https://github.com/george-pogosyan/sentry-charts/issues/1448)) ([0c34ecc](https://github.com/george-pogosyan/sentry-charts/commit/0c34ecca3874c4ff1162c76457993bbe29238b96))
* correct storageClass handling for geodata persistence ([#1524](https://github.com/george-pogosyan/sentry-charts/issues/1524)) ([b2f568d](https://github.com/george-pogosyan/sentry-charts/commit/b2f568d926771208256d47f03a2f39806ca94fe3))
* cronjob Config ([#1881](https://github.com/george-pogosyan/sentry-charts/issues/1881)) ([b5673ef](https://github.com/george-pogosyan/sentry-charts/commit/b5673efddb96533e587194896ddcdb0d0dfeb048))
* del --max-batch-time-ms and enable maxBatchTimeMs in values ([#1412](https://github.com/george-pogosyan/sentry-charts/issues/1412)) ([086b477](https://github.com/george-pogosyan/sentry-charts/commit/086b47720b8fe0ee15fd65eafc5446dccc903366))
...
* **deps:** Use bitnami images from docker.io/bitnamilegacy due to bitnami deprecating their public catalog. See https://github.com/bitnami/charts/issues/35164 ([#1840](https://github.com/george-pogosyan/sentry-charts/issues/1840)) ([e47d24e](https://github.com/george-pogosyan/sentry-charts/commit/e47d24ed1607e0632e7e433a119b9d299b69d9cc))
* discord template typos ([#1408](https://github.com/george-pogosyan/sentry-charts/issues/1408)) ([044cc25](https://github.com/george-pogosyan/sentry-charts/commit/044cc254873911ae668e1c6bd1a34ac0883a1db8))
* duplicated envs for taskworker & taskscheduler ([#1998](https://github.com/george-pogosyan/sentry-charts/issues/1998)) ([f48af58](https://github.com/george-pogosyan/sentry-charts/commit/f48af589a1a4b98005ecedc5bcbf705651e4e2cf))
* external redis functionality for relay ([#1548](https://github.com/george-pogosyan/sentry-charts/issues/1548)) ([6e71fc1](https://github.com/george-pogosyan/sentry-charts/commit/6e71fc169622c2e7e4934bfefd613f613a6c77d2))
* Fix taskbroker persistence enabled flag ([#2036](https://github.com/george-pogosyan/sentry-charts/issues/2036)) ([ed5c3b6](https://github.com/george-pogosyan/sentry-charts/commit/ed5c3b68d0a94962ec8fdbb6790836bdc1a57e99))
* fix typo in value of argument '--consumer-group' for ([#1758](https://github.com/george-pogosyan/sentry-charts/issues/1758)) ([15d1811](https://github.com/george-pogosyan/sentry-charts/commit/15d1811b088b26f20215970d53622e59d4973728))
* generic metric alerts ([#1850](https://github.com/george-pogosyan/sentry-charts/issues/1850)) ([b1ba5b3](https://github.com/george-pogosyan/sentry-charts/commit/b1ba5b35cadb718eb7d664ff23c39c91b19ecbc2))
* global nodeSelector config option not applying to cleanup cron job ([#1654](https://github.com/george-pogosyan/sentry-charts/issues/1654)) ([4e764b5](https://github.com/george-pogosyan/sentry-charts/commit/4e764b5ab006682b609571ae0b9f06014103e194))
* high uwsgi memory usage caused by uwsgi allocating memory based on ([#1974](https://github.com/george-pogosyan/sentry-charts/issues/1974)) ([a50c90c](https://github.com/george-pogosyan/sentry-charts/commit/a50c90c7f44b6647f74c12b000e961c5656029a0))
* incorrect component labels on uptime-results and snuba eap-items deployments ([#2072](https://github.com/george-pogosyan/sentry-charts/issues/2072)) ([143d812](https://github.com/george-pogosyan/sentry-charts/commit/143d812678826e3024e169d7e909cefbfaa4708e))
* invalid parameter in deployments ([#1446](https://github.com/george-pogosyan/sentry-charts/issues/1446)) ([dbafa66](https://github.com/george-pogosyan/sentry-charts/commit/dbafa66025fd9ecb3eb4b07a5df53f97221e77da))
* missing block in ingest-consumer-transactions ([#1680](https://github.com/george-pogosyan/sentry-charts/issues/1680)) ([424f50f](https://github.com/george-pogosyan/sentry-charts/commit/424f50f7f4c5572b13c68659bb91bdaba50c3e1e))
* missing flags required for Queues and Queries instrumentation ([#1622](https://github.com/george-pogosyan/sentry-charts/issues/1622)) ([a9b6b61](https://github.com/george-pogosyan/sentry-charts/commit/a9b6b61c842c5a92f0e011d3ae74c489bb83602c))
* missing profilingFunctionsConsumer.sidecars ([#1627](https://github.com/george-pogosyan/sentry-charts/issues/1627)) ([bcbd6ed](https://github.com/george-pogosyan/sentry-charts/commit/bcbd6ed01e76d741ab500adf1aa6038f0b36f631))
* **nginx:** _assets should rewrite to _static/sentry/dist ([#1719](https://github.com/george-pogosyan/sentry-charts/issues/1719)) ([be4d8c5](https://github.com/george-pogosyan/sentry-charts/commit/be4d8c5619b4fe42e7c47c6f58ea8513e0cff284))
* **nginx:** nginx config name must match in the configmap and in the subchart values  ([#2058](https://github.com/george-pogosyan/sentry-charts/issues/2058)) ([69b5f06](https://github.com/george-pogosyan/sentry-charts/commit/69b5f06c4cd5c5537dbc490cb5e7363bb6ca92ac))
* **nginx:** nginx config name must match in the configmap and in the subchart values ([#2042](https://github.com/george-pogosyan/sentry-charts/issues/2042)) ([f1cc6fd](https://github.com/george-pogosyan/sentry-charts/commit/f1cc6fdf0f5747f115ed997271efdb6b71ec47e3))
* optionally take app_id and app_name from secrets for Github ([#2009](https://github.com/george-pogosyan/sentry-charts/issues/2009)) ([b70306c](https://github.com/george-pogosyan/sentry-charts/commit/b70306ca35b96b5e6a13358ae8988255f49be045))
* reintroduced "Extend Redis functionality" ([#1492](https://github.com/george-pogosyan/sentry-charts/issues/1492)) broke S3 existing secret (from commit 0b7a7b4c) ([#1499](https://github.com/george-pogosyan/sentry-charts/issues/1499)) ([3eb75ef](https://github.com/george-pogosyan/sentry-charts/commit/3eb75ef861c68279975d2baa846bdf9b678474f3))
* relay rename topic events/attachments ([#2033](https://github.com/george-pogosyan/sentry-charts/issues/2033)) ([bc07c1c](https://github.com/george-pogosyan/sentry-charts/commit/bc07c1c1af507af3b2b91b936800c0fd03174202))
* relay rename topic snuba-spans -&gt; ingest-spans ([#2032](https://github.com/george-pogosyan/sentry-charts/issues/2032)) ([859ce4f](https://github.com/george-pogosyan/sentry-charts/commit/859ce4f9e90cf65e43e242e059269317eeee7551))
* relay topic mappings for items ([#2030](https://github.com/george-pogosyan/sentry-charts/issues/2030)) ([a98c78b](https://github.com/george-pogosyan/sentry-charts/commit/a98c78b534a849bdc078234ad93666805a2d7cb7))
* **relay:** indent logging key to be a root key ([#2066](https://github.com/george-pogosyan/sentry-charts/issues/2066)) ([d357411](https://github.com/george-pogosyan/sentry-charts/commit/d357411434a19cc01a50f702a0a252e14ccebb9d))
...
* remove empty arguments ([#2052](https://github.com/george-pogosyan/sentry-charts/issues/2052)) ([1acfcad](https://github.com/george-pogosyan/sentry-charts/commit/1acfcadc8733374a31fbeab5ccad1fbde3e5bbed))
* remove invalid --max-batch-size and --processes parameters from some consumers ([#1416](https://github.com/george-pogosyan/sentry-charts/issues/1416)) ([e42dc12](https://github.com/george-pogosyan/sentry-charts/commit/e42dc12e9bddee1e4d42db7173901ccde0cd3371))
* revert ClickHouse replicas number ([#1392](https://github.com/george-pogosyan/sentry-charts/issues/1392)) ([ad6fc29](https://github.com/george-pogosyan/sentry-charts/commit/ad6fc293e627f78f15b960b8d8cbc0d606cd194f))
* rollback to 24.12.1 ([aa6cad8](https://github.com/george-pogosyan/sentry-charts/commit/aa6cad88fe0f2e0594aff7325d33f3ed643f250a))
* **routing:** nil pointer error when using Gateway API without nginx ([#2047](https://github.com/george-pogosyan/sentry-charts/issues/2047)) ([5820fd1](https://github.com/george-pogosyan/sentry-charts/commit/5820fd19a72cf0e1ccbdb73b33db5ff8393e89c2))
* **sentry-ingest-consumer-attachments:** max batch time ms cli param ([#1895](https://github.com/george-pogosyan/sentry-charts/issues/1895)) ([fb963b3](https://github.com/george-pogosyan/sentry-charts/commit/fb963b38c6eda10f5674e38a0c7644d3c5dcefcd))
* **sentry/sentry/helper:** Redis URL not set when using `externalRedis.existingSecret` or `redis.auth.existingSecret` ([#1871](https://github.com/george-pogosyan/sentry-charts/issues/1871)) ([7c7a943](https://github.com/george-pogosyan/sentry-charts/commit/7c7a9437f9eb0f23fceb67e06f1df7520f2c2d5a))
* **sentry:** correct template syntax for customFeatures conditional ([#1968](https://github.com/george-pogosyan/sentry-charts/issues/1968)) ([b438ba9](https://github.com/george-pogosyan/sentry-charts/commit/b438ba9d03c7a3ad31983a2d13b1c480599a8c51))
* **sentry:** set `SENTRY_SELF_HOSTED_ERRORS_ONLY` when neeeded ([#1812](https://github.com/george-pogosyan/sentry-charts/issues/1812)) ([bccb3fb](https://github.com/george-pogosyan/sentry-charts/commit/bccb3fba295d1f375bf5263fb62a9c65279886d3))
* set replication factor for kafka stability ([#1606](https://github.com/george-pogosyan/sentry-charts/issues/1606)) ([7ebb1f6](https://github.com/george-pogosyan/sentry-charts/commit/7ebb1f636984485dd646eb482978bde3a4f3da36))
* snuba-subscription-consumer-generic-metrics-distribution labels indent ([#1858](https://github.com/george-pogosyan/sentry-charts/issues/1858)) ([43f595c](https://github.com/george-pogosyan/sentry-charts/commit/43f595c10de214dedb0fa11922af937106c5ab37))
* **snuba:** Add missing --no-strict-offset-reset for replacer ([#1559](https://github.com/george-pogosyan/sentry-charts/issues/1559)) ([0c415e7](https://github.com/george-pogosyan/sentry-charts/commit/0c415e704fb2f2cbb984d3e0d5e3b08895834436))
* **snuba:** update consumer group name for profiling chunks consumer ([#1803](https://github.com/george-pogosyan/sentry-charts/issues/1803)) ([d1fb89b](https://github.com/george-pogosyan/sentry-charts/commit/d1fb89b8a9038d9ed47ac592073dfda39c05e3b5))
* support `containerSecurityContext` for Symbolicator Cleaner container ([#1817](https://github.com/george-pogosyan/sentry-charts/issues/1817)) ([517e2ae](https://github.com/george-pogosyan/sentry-charts/commit/517e2ae4d783a0927d743596763b30f24a344bb8))
* symbolicator cleanup command arguments on statefulset ([#1995](https://github.com/george-pogosyan/sentry-charts/issues/1995)) ([12e957a](https://github.com/george-pogosyan/sentry-charts/commit/12e957adc92eb0ba1751cff4f9ce9dc6b0794bab))
* symbolicator statefulset cleaner configuration ([#2004](https://github.com/george-pogosyan/sentry-charts/issues/2004)) ([80b95a4](https://github.com/george-pogosyan/sentry-charts/commit/80b95a4f1c8407f803d1b790b84ff03417f6b885))
* symbolicator storage class ([#1530](https://github.com/george-pogosyan/sentry-charts/issues/1530)) ([26cbaab](https://github.com/george-pogosyan/sentry-charts/commit/26cbaab28dcb0c95ac10723ed62b453c678b9787))
* **templates:** fix indentation for multiple deployments yamls ([#1862](https://github.com/george-pogosyan/sentry-charts/issues/1862)) ([9a10dfd](https://github.com/george-pogosyan/sentry-charts/commit/9a10dfdbca95aff0216b121d8c8b3f40a5b960d4))
* update clickhouse to 4.1.1 ([#1940](https://github.com/george-pogosyan/sentry-charts/issues/1940)) ([0ab54d0](https://github.com/george-pogosyan/sentry-charts/commit/0ab54d08a9a4b9f8ba9f27790ac01c6836a2982d))
* update geoip job hooks and volume handling ([#1529](https://github.com/george-pogosyan/sentry-charts/issues/1529)) ([886eb5f](https://github.com/george-pogosyan/sentry-charts/commit/886eb5fe8110bfb1a973740ca3a1a2e3e776c003))
...
* update readme.md with latest configuration values ([#1666](https://github.com/george-pogosyan/sentry-charts/issues/1666)) ([070b19f](https://github.com/george-pogosyan/sentry-charts/commit/070b19f11c95bd294d9c5419ca5d7d17dfa092fa))
* Update serviceaccount-sentry-uptime-results ([#1869](https://github.com/george-pogosyan/sentry-charts/issues/1869)) ([dbdb24a](https://github.com/george-pogosyan/sentry-charts/commit/dbdb24a3077a692eee456f5f83ae73ffe9dc14be))
* use bitnamilegacy repo for metrics exporter ([#1903](https://github.com/george-pogosyan/sentry-charts/issues/1903)) ([bdca84a](https://github.com/george-pogosyan/sentry-charts/commit/bdca84a2def5a694e89f92cb414a2ab31a3af769))
* Use correct syntax for envFrom in web and worker ([#1563](https://github.com/george-pogosyan/sentry-charts/issues/1563)) ([b834c0e](https://github.com/george-pogosyan/sentry-charts/commit/b834c0e4651633ca88e4c1839d60c0c69cf52087))
* user-create-job hook does not create user ([5f4009b](https://github.com/george-pogosyan/sentry-charts/commit/5f4009b97898bea66749436b792e4a9815df4be8))
* **values:** Add warnings to broken ClickHouse cleanup job ([#1933](https://github.com/george-pogosyan/sentry-charts/issues/1933)) ([84be55c](https://github.com/george-pogosyan/sentry-charts/commit/84be55c35b5eb1e0d8dc86bd64b6761eb4a811df))
* **vroom:** add persistent storage configuration ([#1822](https://github.com/george-pogosyan/sentry-charts/issues/1822)) ([82d2c51](https://github.com/george-pogosyan/sentry-charts/commit/82d2c51228ab040d17586f170b2f37e682ea670c))


### Miscellaneous Chores

* remove bundled clickhouse chart ([#2029](https://github.com/george-pogosyan/sentry-charts/issues/2029)) ([4334428](https://github.com/george-pogosyan/sentry-charts/commit/4334428cee22eef330baa5591d7ce37fc963afe8))
